...
#include "SimulationCudaFacade.hip.h"
#include "SimulationStatistics.hip.h"
#include "CellConnectionProcessor.hip.h"
#include "MutationProcessor.hip.h"
#include "GenomeDecoder.hip.h"
#include "CudaShapeGenerator.hip.h"
    ...
    ConstructionData const& constructionData)
{
    ...
    case CellFunction_Constructor: {
        ...
        newConstructor.numInheritedGenomeNodes = static_cast<uint16_t>(min(USHRT_MAX, numInheritedGenomeNodes));
